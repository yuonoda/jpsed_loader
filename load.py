        ...
        with open(csvPath, 'r') as file:
            ...
            for row in reader:
                ...
                data.append({
                    ...
                    "company_size": row[key_dict['company_size']] if row[key_dict['company_size']] != '' else None,
                    ...
                    "leaving_count": row[key_dict['leaving_count']] if row[key_dict['leaving_count']] != '' else None,
                })
